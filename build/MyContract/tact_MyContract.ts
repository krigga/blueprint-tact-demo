...
async function MyContract_init(owner: Address) {
...
export class MyContract implements Contract {
    ...
    static async init(owner: Address) {
        return await MyContract_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const init = await MyContract_init(owner);
